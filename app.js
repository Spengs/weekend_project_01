$(document).ready(function() {
    ...
    function appendDom(empInfo) {
      ...
      $el.append('<p>' + empInfo.employeefirstname + ' ' + empInfo.employeelastname + ' ' + empInfo.employeenumber + ' ' + empInfo.employeetitle + ' ' + empInfo.employeesalary + ' Salary Cost per Month = ' + totalSalary  + '</p>');
